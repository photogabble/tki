...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Interest rate for account funds
    |--------------------------------------------------------------------------
    |
    | Note that this is calculated every system update
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | It is a good idea to put double what you get on a planet
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Turns a player has to play before ship transfers are allowed
    |--------------------------------------------------------------------------
    |
    |  0=disable
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Max amount of sender's value allowed for ship transfers
    |--------------------------------------------------------------------------
    |
    | 0=disable
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Time in minutes before two similar ship transfers allowed
    |--------------------------------------------------------------------------
    |
    | 0=disable
    |
    ...
    */
    ...
    'link_forums' => 'https://www.reddit.com/r/KabalInvasion',        // Address for the forum link
