...
class KabalScheduler extends ScheduledTask
{
    ...
    {
        // This appears to be NPC Pirates that move about the galaxy trading and
        // attacking however in the `sched_kabal.php` the functionality is
        // commented out.
        // I am unsure if that's due to it being buggy or its been disabled
        // temporarily, or replaced all together.

        // TODO: I'm unsure why the below was commented out

        Log::info(__('scheduler.l_sched_kabal_title'));
