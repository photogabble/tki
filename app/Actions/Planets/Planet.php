...
class Planet
{
    ...
    ): void
    {
        ...
        $attackerfitscapacity = Helpers\CalcLevels::abstractLevels($playerinfo['computer'], $tkireg);
        $ownerfightercapacity = Helpers\CalcLevels::abstractLevels($ownerinfo['computer'], $tkireg);
