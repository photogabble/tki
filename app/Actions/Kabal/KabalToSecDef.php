    ...
    public static function secDef(\PDO $pdo_db, string $lang, array $playerinfo, int $targetlink, Registry $tkireg): void
    {
        ...
        if ($targetlink > 0)
        {
            ...
            if ($all_sector_fighters > 0 || $total_sector_mines > 0 || ($all_sector_fighters > 0 && $total_sector_mines > 0)) // Dest link has defenses so lets attack them
            {
                ...
                Actions\SectorDefense::messageDefenseOwner($pdo_db, $targetlink, $langvars['l_sf_sendlog']);
                ...
                Actions\SectorDefense::messageDefenseOwner($pdo_db, $targetlink, $langvars['l_chm_hehitminesinsector']);
