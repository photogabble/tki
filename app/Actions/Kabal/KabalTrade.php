...
class KabalTrade
{
    public static function trade(\PDO $pdo_db, array $playerinfo, Registry $tkireg): void
    {
        ...
        if ($sectorinfo['port_type'] == "ore") // Port ore
        {
            ...
            $amount_ore = Helpers\CalcLevels::abstractLevels($playerinfo['hull'], $tkireg);
        ...
        if ($sectorinfo['port_type'] == "organics") // Port organics
        {
            ...
            // Since we sell all other holds we set amount to be our total hold limit
            $amount_organics = Helpers\CalcLevels::abstractLevels($playerinfo['hull'], $tkireg);
        ...
        if ($sectorinfo['port_type'] == "goods") // Port goods
        {
            ...
            // Since we sell all other holds we set amount to be our total hold limit
            $amount_goods = Helpers\CalcLevels::abstractLevels($playerinfo['hull'], $tkireg);
