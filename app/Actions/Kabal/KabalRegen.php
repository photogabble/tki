...
class KabalRegen
{
    public static function regen(\PDO $pdo_db, array $playerinfo, int $kabal_unemployment, Registry $tkireg): void
    {
        ...
        $maxenergy = Helpers\CalcLevels::energy($playerinfo['power'], $tkireg); // Regenerate energy
        ...
        $maxarmor = Helpers\CalcLevels::abstractLevels($playerinfo['armor'], $tkireg); // Regenerate armor
        ...
        $available_fighters = Helpers\CalcLevels::abstractLevels($playerinfo['computer'], $tkireg) - $playerinfo['ship_fighters'];
        ...
        $available_torpedoes = Helpers\CalcLevels::abstractLevels($playerinfo['torp_launchers'], $tkireg) - $playerinfo['torps'];
